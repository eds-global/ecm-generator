...
def get_locInfo(inputPath, location, projectName, typology):
    ...
    for file in gb.glob(os.path.join(inputPath, "*.sim")):
        ...
        get_file_details(file_name_without_ext, location, projectName, typology)
    ...
    # combined_data[['FileName','ProjectCode', 'ProjectName', 'ProjectTypology', 'Location']]

    return combined_data
    
def get_file_details(FileName, location, projectName, typology):
    global all_data
